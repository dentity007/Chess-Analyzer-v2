...
var sdkStreamMixin = (stream) => {
  ...
  if (!isBlobInstance(stream) && !isReadableStream(stream)) {
    const name = ((_b2 = (_a2 = stream == null ? void 0 : stream.__proto__) == null ? void 0 : _a2.constructor) == null ? void 0 : _b2.name) || stream;
...
var HttpProtocol = class extends SerdeContext {
  ...
  setHostPrefix(request, operationSchema, input) {
    ...
    if (opTraits.endpoint) {
      let hostPrefix = (_a2 = opTraits.endpoint) == null ? void 0 : _a2[0];
  ...
  async loadEventStreamCapability() {
    const { EventStreamSerde } = await import("./event-streams-N7P6AXIZ.js");
...
var FromStringShapeDeserializer = class extends SerdeContext {
  ...
  read(_schema, data2) {
    ...
    if (ns.isBlobSchema()) {
      return (((_a2 = this.serdeContext) == null ? void 0 : _a2.base64Decoder) ?? fromBase64)(data2);
    }
  ...
  base64ToUtf8(base64String) {
    var _a2, _b2;
    return (((_a2 = this.serdeContext) == null ? void 0 : _a2.utf8Encoder) ?? toUtf8)((((_b2 = this.serdeContext) == null ? void 0 : _b2.base64Decoder) ?? fromBase64)(base64String));
  }
};
...
var HttpInterceptingShapeDeserializer = class extends SerdeContext {
  ...
  read(schema, data2) {
    ...
    const ns = NormalizedSchema.of(schema);
    const traits = ns.getMergedTraits();
    const toString = ((_a2 = this.serdeContext) == null ? void 0 : _a2.utf8Encoder) ?? toUtf8;
    if (traits.httpHeader || traits.httpResponseCode) {
      return this.stringDeserializer.read(ns, toString(data2));
    }
    if (traits.httpPayload) {
      if (ns.isBlobSchema()) {
        const toBytes = ((_b2 = this.serdeContext) == null ? void 0 : _b2.utf8Decoder) ?? fromUtf8;
    ...
    switch (typeof value) {
      case "object":
        ...
        if (ns.isBlobSchema() && "byteLength" in value) {
          this.stringBuffer = (((_a2 = this.serdeContext) == null ? void 0 : _a2.base64Encoder) ?? toBase64)(value);
          return;
        }
      ...
      case "string":
        ...
        if (mediaType) {
          ...
          if (ns.getMergedTraits().httpHeader) {
            this.stringBuffer = (((_b2 = this.serdeContext) == null ? void 0 : _b2.base64Encoder) ?? toBase64)(intermediateValue.toString());
            return;
          }
        }
  ...
  return Object.assign(input, {
    ...
    userAgentAppId: async () => {
      ...
      if (!isValidUserAgentAppId(appId)) {
        const logger2 = ((_b2 = (_a2 = input.logger) == null ? void 0 : _a2.constructor) == null ? void 0 : _b2.name) === "NoOpLogger" || !input.logger ? console : input.logger;
...
var validateSigningProperties = async (signingProperties) => {
  ...
  const authScheme = (_c2 = (_b2 = (_a2 = context.endpointV2) == null ? void 0 : _a2.properties) == null ? void 0 : _b2.authSchemes) == null ? void 0 : _c2[0];
...
function* serializingStructIterator(ns, sourceObject) {
  ...
  for (let i2 = 0; i2 < struct[4].length; ++i2) {
    ...
    const memberNs = new NormalizedSchema([struct[5][i2], 0], key);
...
var JsonShapeSerializer = class extends SerdeContextConfig {
  ...
  _write(schema, value, container) {
    ...
    if (ns.isBlobSchema() && (value instanceof Uint8Array || typeof value === "string") || ns.isDocumentSchema() && value instanceof Uint8Array) {
      ...
      return (((_a2 = this.serdeContext) == null ? void 0 : _a2.base64Encoder) ?? toBase64)(value);
    }
...
async function checkFeatures(context, config, args) {
  ...
  if (typeof config.retryStrategy === "function") {
    ...
    if (typeof retryStrategy.acquireInitialRetryToken === "function") {
      if ((_c2 = (_b2 = retryStrategy.constructor) == null ? void 0 : _b2.name) == null ? void 0 : _c2.includes("Adaptive")) {
  ...
  const identity = (_g2 = (_f2 = context.__smithy_context) == null ? void 0 : _f2.selectedHttpAuthScheme) == null ? void 0 : _g2.identity;
...
var createDefaultUserAgentProvider = ({ serviceId, clientVersion }) => async (config) => {
  ...
  const brands = ((_b2 = navigator == null ? void 0 : navigator.userAgentData) == null ? void 0 : _b2.brands) ?? [];
...
var getRuntimeConfig = (config) => {
  return {
    ...
    protocol: (config == null ? void 0 : config.protocol) ?? new AwsRestJsonProtocol({ defaultNamespace: "com.amazonaws.bedrockruntime" }),
...
TypeRegistry.for(n0).registerError(AccessDeniedException2, AccessDeniedException);
...
TypeRegistry.for(n0).registerError(ConflictException2, ConflictException);
...
TypeRegistry.for(n0).registerError(ModelErrorException2, ModelErrorException);
var ModelNotReadyException2 = [
  -3,
  n0,
  _MNRE,
  {
...
TypeRegistry.for(n0).registerError(ModelNotReadyException2, ModelNotReadyException);
var ModelStreamErrorException2 = [
  -3,
  n0,
  _MSEE,
  {
...
TypeRegistry.for(n0).registerError(ModelStreamErrorException2, ModelStreamErrorException);
var ModelTimeoutException2 = [
  -3,
  n0,
  _MTE,
  {
...
TypeRegistry.for(n0).registerError(ModelTimeoutException2, ModelTimeoutException);
...
var ServiceQuotaExceededException2 = [
  -3,
  n0,
  _SQEE,
  {
...
TypeRegistry.for(n0).registerError(ServiceQuotaExceededException2, ServiceQuotaExceededException);
var ServiceTier = [3, n0, _ST, 0, [_t], [0]];
var ServiceUnavailableException2 = [
  -3,
  n0,
  _SUE,
  {
...
TypeRegistry.for(n0).registerError(ServiceUnavailableException2, ServiceUnavailableException);
...
TypeRegistry.for(n0).registerError(ValidationException2, ValidationException);
var VideoBlock = [3, n0, _VB, 0, [_f, _s], [0, () => VideoSource]];
var WebLocation = [3, n0, _WL, 0, [_url, _do], [0, 0]];
var BedrockRuntimeServiceException2 = [-3, _sm, "BedrockRuntimeServiceException", 0, [], []];
TypeRegistry.for(_sm).registerError(BedrockRuntimeServiceException2, BedrockRuntimeServiceException);
...
var ConverseStreamOutput = [
  ...
  [
    ...
    [() => InternalServerException2, 0],
    [() => ModelStreamErrorException2, 0],
    [() => ValidationException2, 0],
    [() => ThrottlingException2, 0],
    [() => ServiceUnavailableException2, 0]
  ]
];
